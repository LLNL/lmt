...
public class TreeSelectionEvent
     ...
     * @param path_                 - the path that has changed in the selection.
     * @param isNew_                - whether or not the path is new to the selection;
     *                              false means path was removed from the selection.
     * @param oldLeadSelectionPath_ - not used.
     * @param newLeadSelectionPath_ - not used.
     */
    public TreeSelectionEvent(Object source_,
                              TreePath path_, boolean isNew_, TreePath oldLeadSelectionPath_,
