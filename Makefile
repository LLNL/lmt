...
pkgdatadir = $(datadir)/lmt
pkglibdir = $(libdir)/lmt
pkgincludedir = $(includedir)/lmt
top_builddir = .
...
am__aclocal_m4_deps = $(top_srcdir)/config/x_ac_check_pthreads.m4 \
...
ACLOCAL = ${SHELL} /home/garlick/work/lmt/lmt-reorg/config/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /home/garlick/work/lmt/lmt-reorg/config/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /home/garlick/work/lmt/lmt-reorg/config/missing --run autoconf
AUTOHEADER = ${SHELL} /home/garlick/work/lmt/lmt-reorg/config/missing --run autoheader
AUTOMAKE = ${SHELL} /home/garlick/work/lmt/lmt-reorg/config/missing --run automake-1.9
AWK = gawk
CC = gcc
...
MAKEINFO = ${SHELL} /home/garlick/work/lmt/lmt-reorg/config/missing --run makeinfo
META_ALIAS = lmt-2.6.4
META_AUTHOR = 
META_DATE = 
META_LT_AGE = 
META_LT_CURRENT = 
...
infodir = ${prefix}/info
install_sh = /home/garlick/work/lmt/lmt-reorg/config/install-sh
...
SUBDIRS = liblsd libproc liblmt utils cerebro
all: all-recursive
